...
public static class Localizer
{
    private static readonly Dictionary<string, string> FallbackMap = new()
    {
        ...
        ["ChkClickThrough"] = "Mouse Click-Through Mode (pass clicks to underlying apps)",
        ["ChkMirrorText"] = "Mirror Text Horizontally",
        ["LabelTargetScreen"] = "Target Screen:",
        ["ChkPrompterFullscreen"] = "Open Prompter in Borderless Fullscreen",
        ["LabelPresentationTimer"] = "Presentation Timer:",
        ["ChkShowPresentationTimer"] = "Show Speech Timer & Stopwatch",
        ["LabelTargetMinutes"] = "Target Time (minutes, 0 = no limit):",
        ["LabelDisplay"] = "Display {0} ({1}x{2})",
        ["LabelPrimaryDisplay"] = "Primary Display",
        ["LabelPrimarySuffix"] = " [Primary]",
        ["FocusHintFocused"] = "Prompter focused: {0} Play/Pause, R Reset, Up/Down speed, PgUp/PgDn markers",
        ["FocusHintUnfocused"] = "Click prompter to enable keyboard controls",
